class Sneaker < ApplicationRecord
  ...
  has_many :sizes, through: :sneaker_sizes, source: :size
  ...
  #validates :sneaker_name_jp, presence: true, length: { maximum: 150 }, format: { with: /\A[ァ-ヶ0-9]+\z/, message: "はカタカナと数字のみ入力してください" }
